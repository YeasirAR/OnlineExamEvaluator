...
class Student
{
    ...
    {
        $query = "SELECT exam_tbl.* ,std_exam_enrolled.enrolled_exam_status FROM `exam_tbl` 
        LEFT JOIN std_exam_enrolled ON exam_tbl.exam_id = std_exam_enrolled.exam_id AND std_exam_enrolled.std_tbl_std_id = '$std_id'  ORDER BY exam_tbl.exam_id DESC";
        $result = $this->db->select($query);
        return $result;
    }
    ...
    {
        $query = "SELECT exam_tbl.* ,std_exam_enrolled.enrolled_exam_status FROM `exam_tbl` 
        LEFT JOIN std_exam_enrolled ON exam_tbl.exam_id = std_exam_enrolled.exam_id WHERE  enrolled_exam_status=1 ORDER BY exam_tbl.exam_id DESC";
        $result = $this->db->select($query);
        return $result;
    }
